...
@WebServlet({"/registernewuser","/validate","/placeloan","/editLoanProcess","/userregistration"
	,"/applicationdetails","/trackloan","/editloan","/displaystatus","/loanamountrequest","custometcontactdetails"})
...
private ConnectionDao connDao;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			case  "displaystatus" :
				...
				break;
			case  "loanamountrequest" :
				viewName=loanamountrequest(request,response);
				break;
				
			case  "custometcontactdetails" :
				viewName=custometcontactdetails(request,response);
				break;	
	...
	private String custometcontactdetails(HttpServletRequest request, HttpServletResponse response) {
		// TODO Auto-generated method stub
		return null;
	}
	private String loanamountrequest(HttpServletRequest request, HttpServletResponse response) {
		// TODO Auto-generated method stub
		return null;
	}
